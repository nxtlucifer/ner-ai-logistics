...
export const PHRASES: Record<string, Phrase> = {
  ...
  'Camera': { hi: 'कैमरा', as: 'কেমেৰা' },
  'Gallery': { hi: 'गैलरी', as: 'গেলাৰী' },
  'Photo': { hi: 'फोटो', as: 'ফটো' },
  'Plate': { hi: 'नंबर प्लेट', as: 'নম্বৰ প্লেট' },
  'Confirm': { hi: 'पुष्टि', as: 'নিশ্চিত' },
  'Verify truck': { hi: 'ट्रक सत्यापित करें', as: 'ট্ৰাক সত্যাপন কৰক' },
